...
populatePellets::populatePellets()
{
    ...
    pellet *pellet1 = new pellet("BMPs/other/pellet_med.png", -1.0 + (2.0 / 19.0) + pellet_spacing_x, 0.7 - pellet_spacing_y, default_width, default_height);
    ...
    pellet *pellet6 = new pellet("BMPs/other/pellet_med.png", -1.0 + 17.0 * (2.0 / 19.0) + pellet_spacing_x, 0.7 - pellet_spacing_y, default_width, default_height);
    ...
    pellet *pellet23 = new pellet("BMPs/other/pellet_med.png", -1.0 + (2.0 / 19.0) + pellet_spacing_x, -0.7 - pellet_spacing_y, default_width, default_height);
    ...
    pellet *pellet28 = new pellet("BMPs/other/pellet_med.png", -1.0 + 17.0 * (2.0 / 19.0) + pellet_spacing_x, -0.7 - pellet_spacing_y, default_width, default_height);
